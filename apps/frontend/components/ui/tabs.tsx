...
function Tabs({
  ...
  return (
    <TabsPrimitive.Root
      data-slot="tabs"
      className={cn("gap-2",
        props.orientation === "vertical" ? 'flex flex-row': 'flex flex-col',
         className)}
      {...props}
    />
  )
...
function TabsList({
  ...
  orientation,
  ...props
}: React.ComponentProps<typeof TabsPrimitive.List> & IOriented) {
  return (
    <TabsPrimitive.List
      data-slot="tabs-list"
      className={cn(
        "bg-muted text-muted-foreground inline-flex items-center justify-center rounded-lg p-[3px]",
        orientation === "vertical" ? "flex flex-col w-9 max-w-1/4" : "flex flex-row h-9",
        className
      )}
      {...props}
    />
...
function TabsTrigger({
  ...
  orientation,
  ...props
}: React.ComponentProps<typeof TabsPrimitive.Trigger> & IOriented) {
  return (
